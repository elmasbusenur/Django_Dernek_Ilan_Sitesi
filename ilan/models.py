...
class Category(models.Model ):  # model türümüz değişti
    ...
    parent = models.ForeignKey('self', blank=True, null=True, related_name='children', on_delete=models.CASCADE )  # foreignkey self kendi id sine refere edicek, kendi kendine dönecek
